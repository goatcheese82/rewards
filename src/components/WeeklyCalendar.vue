      ...
      <div v-for="(day, index) in weekData" :key="index" class="day-cell">
        ...
        <div class="options">
          ...
          <div class="option-group">
            ...
            >
              <g id="mouth" stroke-width="0"></g>
              <g id="mouth" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="mouth">
                <g>
                  <path
                    class="st0"
            ...
            <div class="checkbox-pair">
              <label>
                <input
                  type="checkbox"
                  v-model="day.mouth.yes"
                  @change="uncheckPair('mouth', index, 'yes')"
                />
                Yes
              </label>
              <label>
                <input
                  type="checkbox"
                  v-model="day.mouth.no"
                  @change="uncheckPair('mouth', index, 'no')"
                />
                No
              </label>
            </div>
